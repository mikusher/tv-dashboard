    ...
    getDefaultChannels() {
        return [
            ...
            },
            {
                ...
                description: 'Canal de entretenimento SIC',
                isDefault: true,
                createdAt: new Date().toISOString()
            },
            {
                ...
                country: 'PT',
                category: 'Entertainment',
                description: 'Canal de entretenimento da RTP',
                isDefault: true,
                createdAt: new Date().toISOString()
            },
            {
                ...
                country: 'PT',
                category: 'News',
                description: 'Canal de notícias CNN Portugal',
                isDefault: true,
                createdAt: new Date().toISOString()
            },
            {
            ...
            },
            {
                ...
                country: 'PT',
                category: 'Entertainment',
                description: 'Canal de entretenimento TVI',
                isDefault: true,
                createdAt: new Date().toISOString()
            },
            {
                ...
                country: 'GB',
                category: 'News',
                description: 'Canal de notícias BBC',
                isDefault: true,
                createdAt: new Date().toISOString()
            },
            {
                ...
                country: 'GB',
                category: 'News',
                description: 'Canal de notícias Sky',
                isDefault: true,
                createdAt: new Date().toISOString()
            }
        ];
